...
pub fn solve(input: String) -> Solution {
    ...
    // Part A: Find all of the directories with a total size of at most 100000. What is the sum of
    ...
    // Part B: Find the smallest directory that, if deleted, would free up enough space on the
    ...
    solution.set_part_b(deleted_dir_size);
